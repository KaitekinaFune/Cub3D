...
/*   Updated: 2021/01/24 21:27:29 by lflint           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		cub_init(t_cub *cub, int mode)
{
	...
	if (mode == 0)
		...
		cub->mlx.scr_h, "Cub3D");
	if (!(open_txts(cub->txt, cub)))
		cub_error(13, cub, "Bad textures/sprite\n");
	if (!(get_plr_coords(cub)))
		cub_error(14, cub, "Wrong player count\n");
