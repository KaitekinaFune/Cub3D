...
/*   Updated: 2021/01/26 15:10:35 by lflint           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
	check_space_vert(t_cub *cub, int i, int j)
{
	int		y;
	int		x;
...
int
	check_space_hori(t_cub *cub, int i, int j)
{
	int		y;
	int		x;
	...
	map_content(t_cub *cub)
{
	...
	while (cub->map[y])
	{
		...
		while (cub->map[y][x])
		{
			...
			{
				if (!check_space_vert(cub, y, x) || !check_space_hori(cub, y, x))
