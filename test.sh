...
echo "\e[1mTesting good maps: \e[0m"
echo  "valgrind ./Cub3D maps/map_valid_no_space.cub"
valgrind ./Cub3D maps/map_valid_no_space.cub
echo "valgrind ./Cub3D maps/map_valid_with_spaces.cub"
valgrind ./Cub3D maps/map_valid_with_spaces.cub

echo "\e[1mTesting bad maps: \e[0m"
echo "\e[1mMissing specifications: \e[0m"
